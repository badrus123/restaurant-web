...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg">ADMIN MONJOEL</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Hovely Simatupang</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                Hovely Simatupang - Web Developer
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url().'Login_admin/logout'?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo base_url().'Form_menu/index'?>">
            <i class="fa fa-edit"></i> <span>Form menu makanan</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url().'Pemesanan_admin/index'?>">
            <i class="fa fa-folder"></i> <span>File Pemesanan menu</span>
          </a>
      </li>
      <li>
          <a href="<?php echo base_url().'Transaksi_admin/index'?>">
            <i class="fa fa-folder"></i> <span>File Transaksi</span>
          </a>
      </li>
